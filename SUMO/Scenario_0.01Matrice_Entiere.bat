...
FOR /L %%s IN (110,20,190) DO (
  ...
  duarouter --configuration-file .\duarouter\duarouter_configuration.xml   --seed %%s  --net-file .\Carte\Carte_Simulation.net.xml --additional-files ./Vtype/Vtype.xml,.\TAZ\taz_simulation.taz.xml --route-files ./Scenario/Copie/od2trips/seed%%sod_Copie.odtrips.xml  --output-prefix seed%%s --output-file ./Scenario/Copie/duarouter/od_Copie.odtrips.rou.xml
