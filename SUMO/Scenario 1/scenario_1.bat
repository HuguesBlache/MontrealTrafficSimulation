...
REM ################### OD2TRIPS SIMULATION
	...
	sumo.exe --seed %%s -c Simulation.sumocfg --net-file .\input\Carte\CarteMontreal_Sans_Un_Res.net.xml --route-files .\input\od2trips\result\point_am\seed%%sscenario_1.odtrips.xml,route.rou.xml --summary .\output\summary\pointe_am\scenario_1_od2trips  --output-prefix seed%%s  --additional-files ./input/Vtype/Vtype.xml,./input/TAZ/districts.taz.xml,parking.xml  --log log\scenario_1_od2trips  --bt-output ./fcd_int/bluetooth_scenario_1_od2trips.xml --tripinfo-output ./tripinfo/tripsinfo_scenario_1_od2trips.xml

REM ################### Flow SIMULATION

	sumo.exe --seed %%s -c Simulation.sumocfg --net-file .\input\Carte\CarteMontreal_Sans_Un_Res.net.xml --route-files .\input\flow\seed%%sscenario_1_flow.xml,route.rou.xml --summary .\output\summary\pointe_am\scenario_1_flow  --output-prefix seed%%s  --additional-files ./input/Vtype/Vtype.xml,./input/TAZ/districts.taz.xml,parking.xml  --log log\scenario_1_flow  --bt-output ./fcd_int/bluetooth_scenario_1_flow.xml --tripinfo-output ./tripinfo/tripsinfo_scenario_1_flow.xml
REM ################### OD2TRIPS SIMULATION

	sumo.exe --seed %%s -c Simulation.sumocfg --net-file .\input\Carte\CarteMontreal_Sans_Un_Res.net.xml --route-files .\input\duarouter\result\pointe_am\seed%%sscenario_1.rou.xml.odtrips.xml,route.rou.xml --summary .\output\summary\pointe_am\scenario_1_duarouter  --output-prefix seed%%s  --additional-files ./input/Vtype/Vtype.xml,./input/TAZ/districts.taz.xml,parking.xml  --log log\scenario_1_duarouter  --bt-output ./fcd_int/bluetooth_scenario_1_duarouter.xml --tripinfo-output ./tripinfo/tripsinfo_scenario_1_duarouter.xml	
