...
netconvert -c .\input\carte\netconvert\config\netconvert.config.xml --osm-files ./input/carte/CarteMontreal.osm -o .\input\Carte\CarteMontreal.net.xml --junctions.join true --no-turnarounds true REM --remove-edges.by-type highway.unclassified,highway.residential 
