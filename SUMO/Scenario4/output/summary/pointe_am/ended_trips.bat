...
python C:\Users\hugue\Sumo\tools\visualization\plot_summary.py -i running_trips -m ended -l seed110 --xtime1  --ylabel "ended vehicles [#]" --xlabel "time [hh:mm:ss]" --title "ended vehicles over time" -o endedvehicles.png 
